...
// if only 1 line is there is if statement then curly bracket can be removed 

// if (a>b)    console.log(`${a} i greater`)
...
// let x=5
// let y=2
//x>y? console.log("x is grreater") : console.log("y is greater");
//x>y && console.log("x is greater");


// let a
// let value=a||10 // if a ka vlaue nhi hai a ko 10 ASSIGN HO JAYEGA 
// console.log(value)
